...
export const appConfig = {
    ...
    // Expired Times
    anonymousTokenExpiredTime: getEnvNumber(
        'ANONYMOUS_TOKEN_EXPIRED_TIME',
        86400
    ),
    ...
    // Throttling
    emailVerificationThrottlingTime: getEnvNumber(
        'EMAIL_VERIFICATION_THROTTLING_TIME',
        60
    ),

    // Email Verification
    emailVerificationCallbackUrl: getEnvString(
