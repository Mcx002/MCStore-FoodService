...
if (jspb.Message.GENERATE_TO_OBJECT) {
     ...
     * @return {!Object}
     */
    proto.customer.CustomerDto.prototype.toObject = function (
        opt_includeInstance
    ) {
 ...
 * @return {!proto.customer.CustomerDto}
 */
proto.customer.CustomerDto.deserializeBinaryFromReader = function (
    msg,
    reader
) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.customer.CustomerDto.serializeBinaryToWriter = function (
    message,
    writer
) {
    var f = undefined
